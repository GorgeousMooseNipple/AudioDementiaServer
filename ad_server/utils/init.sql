...
album_id BIGINT,
artist_id BIGINT,
FOREIGN KEY(album_id) REFERENCES album(id) ON DELETE NO ACTION ON UPDATE CASCADE,
FOREIGN KEY(artist_id) REFERENCES artist(id) ON DELETE NO ACTION ON UPDATE CASCADE
);
...
genre_id BIGINT,
FOREIGN KEY(artist_id) REFERENCES artist(id) ON DELETE NO ACTION ON UPDATE CASCADE,
FOREIGN KEY(genre_id) REFERENCES genre(id) ON DELETE NO ACTION ON UPDATE CASCADE,
FOREIGN KEY(album_id) REFERENCES album(id) ON DELETE NO ACTION ON UPDATE CASCADE
);
